...
import { wsProfileOrdersConnectionStop, wsProfileOrdersConnectionStart } from "../../services/actions/wsProfileOrdersData";
const ProfileOrderDetails = () => {
  ...
  return orderElement ? (
    <main className={`${styles.main}`}>
      ...
      {orderElement.status === "done" && <p className={`mb-15 text text_type_main-default ${styles.textActive}`}>Выполнен</p>}
      {orderElement.status === "created" && <p className="mb-15 text text_type_main-default">Создан</p>}
